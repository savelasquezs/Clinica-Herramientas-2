...
namespace Clinica_Herramientas_2.Infrastructure.GUI.Doctor
{
    public partial class PatientSelectionForm : Form
    {
        ...
        public PatientSelectionForm(DoctorInputs doctorInputs, User currentUser)
        {
        ...
        private void SetupDataGridView()
        {
            ...
            dgvPatients.AlternatingRowsDefaultCellStyle = new DataGridViewCellStyle { BackColor = System.Drawing.Color.FromArgb(240, 253, 244) };
        ...
        private void LoadPatients()
        {
            try
            {
                patients = doctorInputs.GetAllPatients();
