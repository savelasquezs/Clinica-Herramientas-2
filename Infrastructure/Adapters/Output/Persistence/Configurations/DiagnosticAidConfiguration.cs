...
{
    public class DiagnosticAidConfiguration : IEntityTypeConfiguration<DiagnosticAid>
    {
        public void Configure(EntityTypeBuilder<DiagnosticAid> builder)
        {
            builder.ToTable("diagnostic_aid");
